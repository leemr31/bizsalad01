	  ...
	  <div class="d-table w100pro biz-content-wrap-con">
	    ...
	    <div class="d-table w100pro t-center">
	        <div class="new-banner2-title2">
	            <p><span>4단계(목걸이/팔찌/발찌) 기본 부자재 선택</span><span>!</span></p>
	            <p></p>
	        </div>
	    </div>
		...
		<div class="content d-block auto" style="width:300px;">
			...
			<div class="box">
				<input type="text" id="name" class="jsonv input-h40r w100pro big-text3 ma-t-dot5 t-center bold" value="부자재 선택" readonly>
			</div>
...
$("#material").on("change", function(){
	...
	if(material_name == "오링"){
		material_seq = 'matr_0000000015';
	}else if(material_name == "개폐고리"){
		material_seq = 'matr_0000000016';
	}else if(material_name == "클러치"){
		material_seq = 'matr_0000000017';
	}else if(material_name == "기성체인"){
		material_seq = 'matr_0000000018';
	}else if(material_name == "오링개고리세트"){
		material_seq = 'matr_0000000019';
	}else if(material_name == "기타"){
		material_seq = 'matr_0000000020';
...
var manufacture_seq ="manf_0000000008";
var company_seq ="comp_0000000005";
	...
	success:function(data){
		...
		$.ajax({
			...
			success:function(data){
				...
				var cart04 = $("#lastId").val();
	            var cartall = "&cart01="+cart01+"&cart02="+cart02+"&cart03="+cart03+"&cart04="+cart04; 
				$.ajax({
					type:"post",
					url:"/cart/update",
					data:{
					...
					success:function(data){
						...
						location.href="/option/insert5?cart_seq="+cart_seq+"&product_seq="+product_seq+"&manufacutre_seq=manf_0000000004"+cartall;
					},
					error : function(xhr, ajaxSettings, thrownError) 
					   {
					       alert("수정하는데 오류가 발생하였습니다.");
