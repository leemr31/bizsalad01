	  ...
	  <div class="d-table w100pro biz-content-wrap-con">
	    ...
	    <div class="d-table w100pro t-center">
	        <div class="new-banner2-title2">
	            <p><span>5단계 (반지) 조립 여부 선택</span><span>!</span></p>
	            <p></p>
	        </div>
	    </div>
...
var material_seq = "matr_0000000012";
getMprice();
				...
				success:function(data){
					...
					$.ajax({
						...
						success:function(data){
							...
							location.href="/option/insert6(ring)?cart_seq="+cart_seq+"&product_seq="+product_seq+"&manufacutre_seq=manf_0000000009"+cartall;
						},
						error : function(xhr, ajaxSettings, thrownError) 
						   {
						       alert("수정하는데 오류가 발생하였습니다.");
 						...
 						success:function(data){
        					...
        					$.ajax({
        						...
        						success:function(data){
        							alert("성공");
        							//밑에 manufacture_seq는 수기로 다음 단계 입력해주면 됩니다. (품목에 따라 가야할 방향이 다르면 if 조건 주세요)
		        					location.href="/option/insert6(ring)?cart_seq="+cart_seq+"&product_seq="+product_seq+"&manufacutre_seq=manf_0000000006"+cartall;
        						},
        						error : function(xhr, ajaxSettings, thrownError) 
		        				   {
		        				       alert("수정하는데 오류가 발생하였습니다.");
