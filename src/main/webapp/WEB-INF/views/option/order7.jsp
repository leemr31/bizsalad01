	  ...
	  <div class="d-table w100pro biz-content-wrap-con">
	    ...
	    <div class="d-table w100pro t-center">
	        <div class="new-banner2-title2">
	            <p><span>7단계(목걸이/팔찌/발찌) 조립 여부 선택</span><span>!</span></p>
	            <p></p>
	        </div>
	    </div>
				...
				success:function(data){
					...
					$.ajax({
						...
						success:function(data){
							...
							location.href="/option/insert8?cart_seq="+cart_seq+"&product_seq="+product_seq+"&manufacutre_seq=manf_0000000004"+cartall;
						},
						error : function(xhr, ajaxSettings, thrownError) 
						   {
						       alert("수정하는데 오류가 발생하였습니다.");
