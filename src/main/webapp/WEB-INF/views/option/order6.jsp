	  ...
	  <div class="d-table w100pro biz-content-wrap-con">
	    ...
	    <div class="d-table w100pro t-center">
	        <div class="new-banner2-title2">
	            <p><span>6단계(목걸이/팔찌/발찌)2차 가공 선택</span><span>!</span></p>
	            <p></p>
	        </div>
	    </div>
		...
		<div class="content d-block auto" style="width:300px;">
			...
			<div class="box">
				<input type="text" id="name" class="jsonv input-h40r w100pro big-text3 ma-t-dot5 t-center bold" value="2차 가공 선택" readonly>
			</div>
...
$("#material").on("change", function(){
	...
	if(material_name == "각인"){
		material_seq = 'matr_0000000021';
	}else if(material_name == "유화착색"){
		material_seq = 'matr_0000000022';
	}else if(material_name == "빈티지"){
		material_seq = 'matr_0000000023';
	}else if(material_name == "코팅"){
		material_seq = 'matr_0000000024';
	}else if(material_name == "기타가공"){
		material_seq = 'matr_0000000025';
	}else if(material_name == "선택안함"){
		material_seq = 'matr_0000000052';
	}
...
<script>
	...
	var manufacture_seq ="manf_0000000009";
	var company_seq = "comp_0000000001";
		...
		success:function(data){
			$.ajax({
				...
				success:function(data){
					...
					var cart06 = $("#lastId").val();
		            var cartall = "&cart01="+cart01+"&cart02="+cart02+"&cart03="+cart03+"&cart04="+cart04+"&cart05="+cart05+"&cart06="+cart06; 
					$.ajax({
						type:"post",
						url:"/cart/update",
						data:{
						...
						success:function(data){
							...
							location.href="/option/insert7?cart_seq="+cart_seq+"&product_seq="+product_seq+"&manufacutre_seq=manf_0000000004"+cartall;
						},
						error : function(xhr, ajaxSettings, thrownError) 
						   {
						       alert("수정하는데 오류가 발생하였습니다.");
