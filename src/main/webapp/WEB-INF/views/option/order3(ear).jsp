	  ...
	  <div class="d-table w100pro biz-content-wrap-con">
	    ...
	    <div class="d-table w100pro t-center">
	        <div class="new-banner2-title2">
	            <p><span>3단계 귀걸이 땜질 선택</span><span>!</span></p>
	            <p></p>
	        </div>
	    </div>
		...
		<div class="content d-block auto" style="width:300px;">
			...
			<div class="box">
				<input type="text" id="name" class="jsonv input-h40r w100pro big-text3 ma-t-dot5 t-center bold" value="귀걸이 땜질 선택" readonly>
			</div>
				...
				<select id="shape1" class="jsonv select-h40r w100pro d-block big-text3 ">
					...
					<input type=text name="modelInput" id="selfShape1" class="jsonv input-h40r w100pro big-text3 ma-t-dot5" placeholder="형태 직접 입력" disabled>				
...
var material_seq = "";
	...
	$("#material").on("change", function(){
		var material_name = $("#material").val();
		if(material_name == "신주"){
			material_seq = 'matr_0000000003';
		}else if(material_name == "티타늄 침"){
			material_seq = 'matr_0000000002';
		}else if(material_name == "써지컬 침"){
			material_seq = 'matr_0000000026';
		}else if(material_name == "은 침"){
			material_seq = 'matr_0000000027';
		}else if(material_name == "금 침"){
			material_seq = 'matr_0000000028';
		}else if(material_name == "무니켈 침"){
			material_seq = 'matr_0000000029';
		}else if(material_name == "선택안함"){
			material_seq = 'matr_0000000045';
		}
...
var manufacture_seq ="manf_0000000002";
var company_seq ="comp_0000000002";
			...
			success:function(data){
				...
				$.ajax({
					...
					success:function(data){
						...
						location.href="/option/insert4(ear)?cart_seq="+cart_seq+"&product_seq="+product_seq+"&manufacutre_seq=manf_0000000008"+cartall;
					},
					error : function(xhr, ajaxSettings, thrownError) 
					   {
					       alert("수정하는데 오류가 발생하였습니다.");
