                  ...
                  <div class="w100pro pa-2em " style="background-color:#f0f1f5; border-bottom:1px solid #d2d2d2;">
                      <div class="d-table w100pro big-text" style="margin-bottom:0.5em;">
							<c:choose>
								...
								<c:otherwise>
									<a href="/user/read" class="d-table-cell w50pro dg-white pa-dot5 t-center f-left" style="background-color:#000;border:1px solid #000; letter-spacing:0.0.05em; height:50px;">정보수정</a>
                  ...
                  <ul class="auto">
                    ...
                    <li class="menu-label">
                      ...
                      <ul class="sub-menu">
                        ...
                        <li><a href="/">장바구니</a></li>
                        <li><a href="#" onclick="bizPopup('결제관리', '/card/list', 400 );">결제관리</a></li>
                      </ul>
                    </li>
