...
<div class="biz-content-wrap-bmenu-wrap ma-t-3em">
	<div class="biz-content-wrap-bmenu">
	    ...
	    <div class="d-table w100pro pa-dot5 cupoint" style=" font-weight: 500;">
	        ...
	        <a href="/" class="d-table-cell pa-dot5 t-center r6 whitefont cupoint" style="background-color: #a8a9a9;">사용자용</a>
	    </div>
    </div>
</div>
...
<div class="biz-content-wrap-bottom-wrap">
	<div class="biz-content-wrap-bottom">
	    ...
	    <div class="d-table w100pro pa-dot5 mbot-direct" style="border-top:1px solid #555659; font-weight: 500; position:fixed; bottom:0; background-color:#fff; max-width:550px; z-index:999;">
