...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <div class="d-table w100pro biz-content-wrap-top" style="border-bottom:1px solid #ddd">
        ...
        <div class="d-table-cell w40pro pa-1em t-center big-text">
            <a class="big-text bold" style="letter-spacing:1px; color:#000;" href="/company">bizsalad</a><!-- <img src="./img/logo.png">  -->
        </div>
        		...
        		<i class="far fa-bell fa-2x ma-r-dot3"></i>
							...
							<c:choose>
								<c:when test="${company_id == null}">
							    	<a href="/company/login" target="_self" style="color:#000;">
							    		<i class="fas fa-user-circle fa-2x"></i>
							    	</a>
								</c:when>
								<c:otherwise>
									<a href="/company/read" target="_self" style="color:#000;">
