...
<body>
	...
	<form name="frm" enctype="multipart/form-data" method="post">
		<input type="text" name="company_seq" value="${vo.company_seq }"/>
		<input type="hidden" name="rp_bbs_seq" value="${vo.rp_bbs_seq }"/>
		<div border=1 width=500>
			...
			<input type="button" id="btnList" value="목록" onClick="location.href='/report/list'"/>
			<input type="button" id="btnDelete" value="삭제"/>
	</form>	
	<div id="divReply">
	<hr/>
	<jsp:include page="report_reply.jsp"/>
	</div>
</body>
<script>
	...
	$(frm).on("submit", function(e){	
		e.preventDefault();		
		if(!confirm("내용을 수정 하시겠습니까??")) return;
		frm.action = "/report/update";
		frm.method = "post";
		frm.submit();
	});
