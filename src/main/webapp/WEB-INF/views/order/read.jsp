	...
	<div id="contents" style="margin:10px;padding:10px;">
		<div id="openContent" class="pa-1em t-center">
			...
			<span id="level0" class="select-h40r w100pro d-block big-text3 ">기본입력정보</span>
				<div id="content0-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					...
					{{#each .}}
						...
						<hr class="ma-t-1em"/>
						<div>
							<div class="bold big-text3 d-i-b ma-t-dot5">참고 견본 사진</div> 
							<div><img src="/displayFile?fullName={{img}}" class="ma-t-dot5" width=150 height=100/></div>
						</div>
					{{/each}}
					<button class="btn-h40r w30pro ma-b-2em ma-r-dot5 ma-t-1em">확인</button>
					<button class="btn-h40r w30pro ma-b-2em ma-r-dot5">빠른진행</button>
					</script>
					<br>
				<span id="level1" class="select-h40r w100pro d-block big-text3 ">1단계</span>
				<div id="content1-1"  class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp1-1" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>카테고리</b> - {{product_name}}</div>
						<div class="ma-t-dot5 big-text3D"><b>담당업체명 </b>: {{company_name}}</div>
						<div day={{day}} work_date={{work_date}} class="ma-t-dot5 big-text3"><b>예정 완료일</b> : {{work work_date}}</div>
					{{/each}}
					
					</script>
					<div id="content1-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					...
					{{#each .}}
						...
						<hr class="ma-t-1em"/>
						<div>
							<div class="bold big-text3 d-i-b ma-t-dot5">업체로 전송한 참고사진</div>
							<div><img src="/displayFile?fullName={{img}}" class="ma-t-dot5" width=150 height=100/></div>
						</div>
						<button id="btnAgree" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
						<span id="agree1" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                    	  <span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk1" disabled/>동의</span>
                  		</span>
					</div>
					{{/each}}
					<button class="btn-h40r w30pro ma-b-2em ma-r-dot5 ma-t-1em">확인</button>
					...
					<div id="content1-3"  class="content-info cixx content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp1-3" type="text/x-handlebars-template">
						<span>업체 작업 내용</span>
						{{#each .}}
							<textarea cols="40" rows="5" class="jsonv textarea-r-6 w100pro big-text2">{{contents}}</textarea>
							<div>
							...
							<button id="facReply1" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply1" style="display: none;">
								<textarea type="text" id="replytxt1" class="jsonv textarea-r-6 small-text ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert1" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
						{{/each}}
					</script>
		...
		<span id="level2" class="select-h40r w100pro d-block big-text3 ">2단계</span>
			<div id="content2-1"  class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp2-1" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>카테고리</b> - {{product_name}}</div>
						<div class="ma-t-dot5 big-text3"><b>담당업체명</b> : {{company_name}}</div>
						<div day={{day}} work_date={{work_date}} class="ma-t-dot5 big-text3"><b>예정 완료일</b> : {{work work_date}}</div>
					{{/each}}

				</script>
				<div id="content2-2"  class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp2-2" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>공정명칭</b> : {{name}}</div>
						<div class="ma-t-dot5 big-text3"><b>필요한 재료명</b> : {{material}}</div>
						<button id="btnAgree2" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 

						<span id="agree2" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                    	  <span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk2" disabled/>동의</span>
                  		</span>
					{{/each}}
					<button class="btn-h40r w30pro ma-b-2em ma-r-dot5 ma-t-1em">확인</button>
					<button class="btn-h40r w30pro ma-b-2em ma-r-dot5">빠른진행</button>
					...
					<script id="temp2-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply2" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply2" style="display: none;">
								<textarea type="text" id="replytxt1" class="jsonv textarea-r-6 small-text2 ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert2" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
		...
		<span id="level3" class="select-h40r w100pro d-block big-text3 ">3단계</span>
			<div id="content3-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content3-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp3-2" type="text/x-handlebars-template">
					{{#each .}}
						...
						<button id="btnAgree3" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
						<span id="agree3" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                    	  <span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk3" disabled/>동의</span>
                  		</span>
					{{/each}}
					<button class="btn-h40r w30pro ma-b-2em ma-r-dot5 ma-t-1em">확인</button>
					<button class="btn-h40r w30pro ma-b-2em ma-r-dot5">빠른진행</button>
					...
					<script id="temp3-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply3" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply3" style="display: none;">
								<textarea type="text" id="replytxt3" class="jsonv textarea-r-6 small-text2 ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert3" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
		...
		<span id="level4" class="select-h40r w100pro d-block big-text3 ">4단계</span>
			<div id="content4-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content4-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp4-2" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>공정명칭</b> : {{name}}</div>
						<div class="ma-t-dot5 big-text3"><b>필요한 재료명</b> : {{material}}</div>

					<button id="btnAgree4" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
					<span id="agree4" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                    <span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk4" disabled/>동의</span>
                  	</span>
					...
					<script id="temp4-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply4" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply4" style="display: none;">
								<textarea type="text" id="replytxt4" class="jsonv textarea-r-6 small-text2 ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert4" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
						{{/each}}
					</script>
		...
		<span id="level5" class="select-h40r w100pro d-block big-text3 ">5단계</span>
			<div id="content5-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content5-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp5-2" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>공정명칭</b> : {{name}}</div>
						<div class="ma-t-dot5 big-text3"><b>필요한 재료명</b> : {{material}}</div>

					<button id="btnAgree5" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
					<span id="agree5" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                    <span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk5" disabled/>동의</span>
                  	</span>
					...
					<div id="content5-3" class="content-info cixx jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp5-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply5" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply5" style="display: none;">
								<textarea type="text" id="replytxt5" class="jsonv textarea-r-6 small-text ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert5" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
						{{/each}}
					</script>
		...
		<span id="level6" class="select-h40r w100pro d-block big-text3 ">6단계</span>
			<div id="content6-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content6-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp6-2" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>공정명칭</b> : {{name}}</div>
						<div class="ma-t-dot5 big-text3"><b>필요한 재료명</b> : {{material}}</div>

					<button id="btnAgree6" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
					<span id="agree6" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                    <span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk6" disabled/>동의</span>
                  	</span>
					...
					<div id="content6-3" class="content-info cixx jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp6-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply6" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply6" style="display: none;">
								<textarea type="text" id="replytxt6" class="jsonv textarea-r-6 small-text ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert6" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
		...
		<span id="level7" class="select-h40r w100pro d-block big-text3 ">7단계</span>
			<div id="content7-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content7-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp7-2" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>공정명칭</b> : {{name}}</div>
						<div class="ma-t-dot5 big-text3"><b>필요한 재료명</b> : {{material}}</div>

					<button id="btnAgree7" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
					<span id="agree7" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                    <span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk7" disabled/>동의</span>
                  	</span>
					...
					<div id="content7-3" class="content-info cixx jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp7-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply7" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply7" style="display: none;">
								<textarea type="text" id="replytxt7" class="jsonv textarea-r-6 small-text ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert7" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
		...
		<span id="level8" class="select-h40r w100pro d-block big-text3 ">8단계</span>
			<div id="content8-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content8-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp8-2" type="text/x-handlebars-template">
					{{#each .}}
						<div class="ma-t-dot5 big-text3"><b>공정명칭</b> : {{name}}</div>
						<div class="ma-t-dot5 big-text3"><b>필요한 재료명</b> : {{material}}</div>
					
						<button id="btnAgree8" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
						<span id="agree8" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                   		<span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk8" disabled/>동의</span>
                  		</span>
					...
					<div id="content8-3" class="content-info cixx jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp8-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply8" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply8" style="display: none;">
								<textarea type="text" id="replytxt8" class="jsonv textarea-r-6 small-text ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert8" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
						{{/each}}
					</script>
		...
		<span id="level9" class="select-h40r w100pro d-block big-text3 ">9단계</span>
			<div id="content9-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content9-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp9-2" type="text/x-handlebars-template">
					...
					<button id="btnAgree9" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
						<span id="agree9" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                   		<span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk9" disabled/>동의</span>
                  		</span>
					...
					<div id="content9-3" class="content-info cixx jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp9-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply9" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply9" style="display: none;">
								<textarea type="text" id="replytxt9" class="jsonv textarea-r-6 small-text ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert9" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
						{{/each}}
					</script>
		...
		<span id="level10" class="select-h40r w100pro d-block big-text3 ">10단계</span>
			<div id="content10-1" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				...
				<div id="content10-2" class="content-info jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
				<script id="temp10-2" type="text/x-handlebars-template">
					...
					<button id="btnAgree10" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">진행동의여부 확인</button> 
						<span id="agree10" class="big-text3" style="display:none; font-weight: 400;">진행동의여부 내용
                   		<span style="font-weight: 400;" class="big-text3"><input type="checkbox" id="agreeChk10" disabled/>동의</span>
                  		</span>
					...
					<div id="content10-3" class="content-info cixx jsonv textarea-r-6 w100pro big-text3 ma-t-dot5" style="display:none;"></div>
					<script id="temp10-3" type="text/x-handlebars-template">
						...
						{{#each .}}
							...
							<button id="facReply10" class="btn-h40r w30pro ma-b-2em ma-r-dot5">댓글남기기</button>
							<div id="divReply10" style="display: none;">
								<textarea type="text" id="replytxt10" class="jsonv textarea-r-6 small-text ma-t-dot5 v-middle" placeholder="댓글 입력" rows="2" cols="31"/>
								<button id="replyInsert10" fr="{{fr_bbs_seq}}" class="d-table-cell btn-h40r w100pro d-i-b ma-l-dot5 ma-t-dot5 v-middle" style="height: 56px;">댓글등록</button>
							</div>
						{{/each}}
					</script>
	</div>
		
		<div class="d-table auto">
			<label class="d-i-b ma-r-1em"><input type="checkbox" name="type" id="orderSample" style="background:red;" disabled><span>샘플만</span></label>
			<label class="d-i-b"><input type="checkbox" name="type" id="orderAll" disabled><span>전체 공정 주문</span></label>
		</div>
		
		
	</div>
	
	<div class="d-table auto w100pro t-center ma-b-1em" style="width: 300px;">
		<button id="btnReview" class="btn-h40r w70pro d-i-b ma-b-dot5 auto">리뷰 쓰기</button>
	</div>
	
	<div id="review-ifm" class="d-table auto w100pro t-center" style="display:none;">
		<iframe id='ifrm' name='ifrm' src='' frameborder='0' width='100%' height='300px' scrolling='no'></iframe>
	</div>
