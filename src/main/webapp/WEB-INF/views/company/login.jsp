...
<body class="" style="width:100%; height:100%;">
	  ...
	  <div class="d-table w100pro biz-content-wrap-con">
	    ...
	    <div class="d-table w100pro t-center">
	        <div class="new-banner2-title2">
	            <p><span>업체 로그인</span><span>!</span></p>
	            <p>업체회원만 이용이 가능합니다.</p>
	        </div>
	    </div>
	...
	<form action="login" method="post" name="frm" class="d-block auto" style="width:300px;">
		<div id="id-form">
			<input type="text" name="company_id" class=" input-h40r w100pro big-text3" id="company_id" placeholder="이메일">
			<span id="id-prompt"></span>
		</div>
		<div id="pass-form">
			<input type="password" name="company_pass" class=" input-h40r w100pro big-text3 ma-t-dot5"  id="company_pass" placeholder="패스워드">
	...
	<div class="d-table w100pro auto t-center big-text3">
		<a href="" class="pa-dot5" style="color:#000;">아이디 찾기</a> | <a href="" class="pa-dot5" style="color:#000;">비밀번호 찾기</a> | <a href="/company/insert" class="pa-dot5" style="color:#000;">회원가입</a>
	</div>
		...
		$.ajax({
			...
			success : function(data) {
				if (data.result == 0) {
					...
					alert("로그인 성공")
					//alert(data.path);
					//location.href = "/process/list?company_seq="+${company_seq};
					location.href = "/process/list?company_seq="+data.seq;
				} else {
