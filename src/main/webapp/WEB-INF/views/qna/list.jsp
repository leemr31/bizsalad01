...
<body class="" style="width:100%; height:100%;">
	...
	<div>
		<select id="searchType">
			...
			<option value="type">질문 유형</option>
		</select>
	...
	<div id="list">
		...
		<script id="temp" type="text/x-handlebars-template">
			...
			<tr class="row">
           	 	<td>{{type}}</td>
           		<td onClick="location.href='/qna/read?qna_bbs_seq={{qna_bbs_seq}}'">{{title}}</td>
				<td>{{user_id}}</td>
            	<td>{{qna_bbs_date}}</td>
			</tr>
			{{/each}}
	...
	<div id="pagination"></div>
		<button onClick="location.href='/qna/insert'">글쓰기</button> //로그아웃 상태에서는 로그인으로 인터셉터 해주세요
	<!------------------------------------------------>
