...
<body>
	...
	<form name="frm" enctype="multipart/form-data" method="post">
		...
		<input type="hidden" name="qna_bbs_seq" value="${vo.qna_bbs_seq }"/>
		...
		<c:if test="${vo.user_seq == user_seq}">
			...
			<input type="button" id="btnList" value="목록" onClick="location.href='/qna/list'"/>
