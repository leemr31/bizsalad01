...
<body class="" style="width:100%; height:100%;">
	...
	<div id="biz-content-wrap">
		...
		<jsp:include page="/WEB-INF/views/layout/company/ptop.jsp"></jsp:include>
		<jsp:include page="/WEB-INF/views/layout/company/mtop.jsp"></jsp:include>
		<jsp:include page="/WEB-INF/views/layout/company/mmenu.jsp"></jsp:include>
		...
		<!-------------------------------------- index contents start //----------------------------------->
		 ...
		 <div class="great-text bold auto t-center">장바구니</div>
	...
	<script>
	  ...
	  <br/><br/><br/><br/>
		...
		<jsp:include page="/WEB-INF/views/layout/company/mcontent.jsp"></jsp:include>
		<jsp:include page="/WEB-INF/views/layout/company/mbot.jsp"></jsp:include>
		<jsp:include page="/WEB-INF/views/layout/company/mpopup.jsp"></jsp:include>
